...
% #   see the COPYING file distributed with CoSMoMVPA.           #
    ...
    if opt.check_partitions
        cosmo_check_partitions_AP(partitions, ds);
    end
    ...
    for fold=1:npartitions
        ...
        test_data = sample_avg(test_idxs,:);
